...
}, window.BSS_CSR_CONFIG || {});

const TOKEN_KEY = 'bss.csr.token';
const EXP_KEY = 'bss.csr.tokenExp';
const VERIFIER_KEY = 'bss.csr.verifier';
const STATE_KEY = 'bss.csr.state';
...
/** Agents always sign in: resolves true when authenticated, else redirects. */
