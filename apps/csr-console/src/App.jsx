  ...
  return (
    <>
      <header className="top">
        ...
        <div className="who">
          <HelpDrawer />
          <button className="ghost small keyhint" title={`Command palette (${MOD} K) — pages, recent customers, every action on this page`} data-testid="palette-button"
            onClick={() => window.dispatchEvent(new KeyboardEvent('keydown', { key: 'k', metaKey: isMacLike, ctrlKey: !isMacLike, bubbles: true }))}>
