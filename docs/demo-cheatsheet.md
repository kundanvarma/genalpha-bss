...
> **eSIM:** *[mobile plan → cart → pick ⚡ eSIM → pay 4242…]* "Watch it activate on its own." *[Home: the new line as a service card — number, data left, active — seconds]* "No human touched that."
