...
public class OrganizationController {
    ...
    public OrganizationController(OrganizationService service, FieldSelector fieldSelector) {
    ...
    public ResponseEntity<List<?>> list(
        ...
        PagedResult<OrganizationDto> result = service.findAll(offset, limit, filters);
