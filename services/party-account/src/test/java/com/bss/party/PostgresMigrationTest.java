...
class PostgresMigrationTest {
    ...
    @Autowired
    private BillingAccountRepository billingAccounts;
    ...
    void flywayAppliesMigrationsAndEntitiesValidateAgainstPostgres() {
        ...
        assertThat(billingAccounts.count()).isZero();
        assertThat(individuals.count()).isZero();
    ...
    void migratedSchemaHasTheExpectedTables() {
        Integer tables = jdbcTemplate.queryForObject("""
                ...
                WHERE table_schema = 'public'
                  AND table_name IN ('individual', 'organization', 'billing_account')
                """, Integer.class);
