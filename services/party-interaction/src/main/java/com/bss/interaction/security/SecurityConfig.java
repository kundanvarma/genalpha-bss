package com.bss.interaction.security;
 ...
 * validates JWTs from whatever OIDC issuer OIDC_ISSUER_URI points at.
 * Interactions are the customer contact history: reads need the read authority
 * (customers party-scoped, agents org-scoped), writes the write authority.
...
public class SecurityConfig {
    ...
    private static final String READ = "interaction:read";
    private static final String WRITE = "interaction:write";
