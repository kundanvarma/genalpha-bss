...
ALTER TABLE party_interaction ADD COLUMN tenant_id VARCHAR(64) NOT NULL DEFAULT 'genalpha';

CREATE INDEX idx_party_interaction_tenant ON party_interaction (tenant_id);
