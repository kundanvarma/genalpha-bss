 ...
 * other issuer are rejected before authorization runs. Slot availability is
 * anonymous shop-window information; appointments themselves need
 * "appointment:read"/"appointment:write" and are party-scoped for customers.
 * Health and the OpenAPI docs stay open.
 */
@Configuration
@EnableWebSecurity
