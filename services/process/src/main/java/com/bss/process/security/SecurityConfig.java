package com.bss.process.security;
    ...
    SecurityFilterChain apiSecurity(HttpSecurity http, ClaimAuthoritiesConverter authoritiesConverter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // ops-grade, staff-only: flows are read with
                        // ordering:read; spec edits and the task lever are
                        // ordering:write. No customer-facing surface exists.
                        .requestMatchers(HttpMethod.GET, ApiConstants.BASE_PATH + "/**").hasAuthority("ordering:read")
                        .requestMatchers(ApiConstants.BASE_PATH + "/**").hasAuthority("ordering:write")
