...
ALTER TABLE customer_bill ENABLE ROW LEVEL SECURITY;
CREATE POLICY tenant_isolation ON customer_bill
    USING (current_setting('app.tenant_id', true) = '__system__'
           OR tenant_id = current_setting('app.tenant_id', true))
    WITH CHECK (current_setting('app.tenant_id', true) = '__system__'
           OR tenant_id = current_setting('app.tenant_id', true));

ALTER TABLE applied_billing_rate ENABLE ROW LEVEL SECURITY;
CREATE POLICY tenant_isolation ON applied_billing_rate
    USING (current_setting('app.tenant_id', true) = '__system__'
           OR tenant_id = current_setting('app.tenant_id', true))
    WITH CHECK (current_setting('app.tenant_id', true) = '__system__'
           OR tenant_id = current_setting('app.tenant_id', true));
