 ...
 * registry entry for their verified token issuer. Anonymous callers: the
 * deployment's default tenant. Every repository query carries this — a
 * tenant can never see or touch another tenant's rows, and cross-tenant
 * ids read as 404, not 403.
 */
@Component
