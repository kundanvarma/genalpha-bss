package com.bss.recommendation.security;
 ...
 * personal consumption data. Reads require "recommendation:read" (customers
 * party-scoped); writes "recommendation:read" — the ingest endpoint is the
    ...
    SecurityFilterChain apiSecurity(HttpSecurity http, ClaimAuthoritiesConverter authoritiesConverter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, ApiConstants.BASE_PATH + "/**").hasAuthority("recommendation:read")
