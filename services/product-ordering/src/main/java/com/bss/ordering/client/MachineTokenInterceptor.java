 ...
 * calls. The ordering service authenticates as its own machine identity
 * (registration "bss-m2m"), whose scopes are limited to exactly what
 * orchestration needs: catalog:read, party:read, inventory:write. The
