 ...
 * require the "ordering:read" authority, writes "ordering:write". Health and the
...
public class SecurityConfig {
    ...
    private static final String READ = "ordering:read";
    private static final String WRITE = "ordering:write";
