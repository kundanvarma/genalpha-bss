 ...
 * require the "inventory:read" authority, writes "inventory:write". Health and the
...
public class SecurityConfig {
    ...
    private static final String READ = "inventory:read";
    private static final String WRITE = "inventory:write";
