 ...
 * other issuer are rejected before authorization runs. Campaigns are pure
 * back-office: reads require "quote:read", writes "quote:write" —
 * customers never talk to this API, they only receive its output through
 * TMF681. Health and the OpenAPI docs stay open for probes and discovery.
 */
@Configuration
@EnableWebSecurity
    ...
    SecurityFilterChain apiSecurity(HttpSecurity http, ClaimAuthoritiesConverter authoritiesConverter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, ApiConstants.BASE_PATH + "/**").hasAuthority("quote:write")
