package com.bss.userroles.security;
 ...
 * personal consumption data. Reads require "roles:admin" (customers
 * party-scoped); writes "roles:admin" — the ingest endpoint is the
