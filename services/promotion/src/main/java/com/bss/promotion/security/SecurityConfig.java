package com.bss.promotion.security;
 ...
 * other issuer are rejected before authorization runs. Code validation is
 * the anonymous shop window; everything else is
 * personal consumption data. Reads require "promotion:read" (customers
 * party-scoped); writes "promotion:write" — the ingest endpoint is the
    ...
    SecurityFilterChain apiSecurity(HttpSecurity http, ClaimAuthoritiesConverter authoritiesConverter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, ApiConstants.BASE_PATH + "/checkPromotion").permitAll()
                        .requestMatchers(HttpMethod.GET, ApiConstants.BASE_PATH + "/**").hasAuthority("promotion:read")
                        .requestMatchers(HttpMethod.POST, ApiConstants.BASE_PATH + "/**").hasAuthority("promotion:write")
                        .requestMatchers(HttpMethod.PATCH, ApiConstants.BASE_PATH + "/**").hasAuthority("promotion:write")
                        .requestMatchers(HttpMethod.DELETE, ApiConstants.BASE_PATH + "/**").hasAuthority("promotion:write")
