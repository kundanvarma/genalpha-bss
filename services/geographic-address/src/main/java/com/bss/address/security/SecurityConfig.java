package com.bss.address.security;
 ...
 * personal consumption data. Reads require "address:read" (customers
 * party-scoped); writes "address:write" — the ingest endpoint is the
