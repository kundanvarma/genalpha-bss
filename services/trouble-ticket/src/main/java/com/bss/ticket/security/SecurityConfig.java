 ...
 * other issuer are rejected before authorization runs. Tickets are personal
 * support records: reads need the read authority (customers party-scoped,
 * agents org-scoped), writes the write authority. Health and the OpenAPI docs
...
public class SecurityConfig {
    ...
    private static final String READ = "ticket:read";
    private static final String WRITE = "ticket:write";
