package com.bss.document.security;
 ...
 * personal consumption data. Reads require "document:read" (customers
 * party-scoped); writes "document:write" — the ingest endpoint is the
