...
/** TMF633 Service Catalog Management — ExportJob, on the v4 path and the v3 alias. */
@RestController
@Validated
@RequestMapping({ApiConstants.SERVICE_CATALOG_BASE_PATH + "/exportJob",
        ApiConstants.SERVICE_CATALOG_V3_BASE_PATH + "/exportJob"})
public class ExportJobController extends ServiceCatalogJobController {

    public ExportJobController(ServiceCatalogJobService service, FieldSelector fieldSelector) {
        super(service, fieldSelector, ServiceCatalogJob.EXPORT);
    }
