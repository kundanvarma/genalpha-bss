 ...
 * other issuer are rejected before authorization runs. The catalog is the
 * public price list, so reads are anonymous — guests browse offers before
 * they have any identity. Writes require "catalog:write". Health and the
    ...
    SecurityFilterChain apiSecurity(HttpSecurity http, ClaimAuthoritiesConverter authoritiesConverter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/acp/product_feed").permitAll()
