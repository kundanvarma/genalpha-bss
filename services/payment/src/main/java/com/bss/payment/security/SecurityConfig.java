 ...
 * validates JWTs from whatever OIDC issuer OIDC_ISSUER_URI points at. Payments
 * are personal financial records: reads require "payment:read" (customers are
 * additionally party-scoped), writes "payment:write". Health and the OpenAPI
