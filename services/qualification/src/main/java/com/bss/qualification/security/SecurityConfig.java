 ...
 * other issuer are rejected before authorization runs. The qualification
 * check is anonymous shop-window functionality (like reading the catalog),
 * so its POST is open; the serviceable-area rule data requires
