package com.bss.qualification.security;
 ...
 * validates JWTs from whatever OIDC issuer OIDC_ISSUER_URI points at. The
 * qualification check is anonymous shop-window functionality (like reading the
 * catalog), so its POST is open; the serviceable-area rule data requires
 * "qualification:write". Health and the OpenAPI docs stay open.
 */
@Configuration
@EnableWebSecurity
