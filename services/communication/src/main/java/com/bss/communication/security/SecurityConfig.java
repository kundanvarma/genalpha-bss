 ...
 * validates JWTs from whatever OIDC issuer OIDC_ISSUER_URI points at. Slot
 * availability is anonymous shop-window information; communications themselves
 * need "communication:read"/"communication:write" and are party-scoped for
