 ...
 * other issuer are rejected before authorization runs. Usage records are
 * personal consumption data. Reads require "usage:read" (customers
 * party-scoped); writes "usage:write" — the ingest endpoint is the
