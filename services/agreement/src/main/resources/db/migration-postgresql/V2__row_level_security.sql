...
DO $$
BEGIN
    IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = 'agreement_app') THEN
        CREATE ROLE agreement_app LOGIN PASSWORD 'agreement_app';
    END IF;
END
$$;
GRANT USAGE ON SCHEMA public TO agreement_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO agreement_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO agreement_app;
