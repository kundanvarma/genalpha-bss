...
class GatewayRoutingTest {
    ...
    void everyComponentAndChannelHasARoute() {
        ...
        assertThat(ids).containsExactlyInAnyOrder(
                ...
                "usage", "agreement", "promotion", "campaign", "intelligence", "quote", "sales", "flow", "porting", "user-roles", "operator-onboarding", "geographic-address", "document", "recommendation", "payment-method", "service-orchestration", "dealer-channel", "assurance", "policy", "knowledge", "insight", "pim", "csr-console", "admin-console", "business-console", "dealer-console", "storefront", "mobile-app");
    }
