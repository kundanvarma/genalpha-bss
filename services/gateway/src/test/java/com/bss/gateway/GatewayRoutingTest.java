...
class GatewayRoutingTest {
    ...
    void everyComponentAndChannelHasARoute() {
        ...
        assertThat(ids).containsExactlyInAnyOrder(
                ...
                "usage", "agreement", "promotion", "user-roles", "geographic-address", "recommendation", "payment-method", "service-orchestration", "assurance", "csr-console", "admin-console", "storefront");
    }
