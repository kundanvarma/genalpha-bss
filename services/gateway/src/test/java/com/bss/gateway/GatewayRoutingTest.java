...
class GatewayRoutingTest {
    ...
    void everyComponentAndChannelHasARoute() {
        ...
        assertThat(ids).containsExactlyInAnyOrder(
                ...
                "usage", "agreement", "promotion", "campaign", "intelligence", "quote", "user-roles", "geographic-address", "document", "recommendation", "payment-method", "service-orchestration", "assurance", "csr-console", "admin-console", "storefront", "mobile-app");
    }
