...
<details>
<summary><b>Every feature is verified end-to-end in a real browser</b> — 227 Playwright suites. Expand the full ledger, one honest paragraph per epoch…</summary>

**Every feature is verified end-to-end in a real browser** — 227 Playwright suites drive the
