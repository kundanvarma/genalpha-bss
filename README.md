...
**Every feature is verified end-to-end in a real browser** — sixty-nine Playwright suites drive the
...
- 🗺️ **[Capability map](docs/capability-map.md)** — TM Forum business capabilities → components of this BSS, with a suite number on every ✅ and an HONEST gap list (OCS, tax, ERP/GL, roaming settlement, fraud/RA, loyalty, FSM, real OSS…) framed as an integration plan behind the seams, not a wall
