...
- 137 end-to-end browser suites, all green; 25 official TM Forum CTKs at zero failures — every published kit that matches a served capability
...
- 🗺️ **[Capability map](docs/capability-map.md)** — TM Forum business capabilities → components of this BSS, with a suite number on every ✅ and an HONEST gap list (OCS, tax, ERP/GL, roaming settlement, fraud/RA, FSM, real OSS…) framed as an integration plan behind the seams, not a wall
