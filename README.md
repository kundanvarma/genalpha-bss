...
→ [Quickstart](#quickstart) (demo data + every persona login) · [CTK scorecard](docs/ctk-conformance.md) · [the proof run — 87/87, attempts on record](https://kundanvarma.github.io/genalpha-bss/proof-run.html) · [guided demo](#a-look-at-it) · [Growth guide](docs/growth-guide.md)
