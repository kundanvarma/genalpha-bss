...
- 232 end-to-end browser suites; 28 official TM Forum CTKs certified at zero failures, each on the dataset of its day — every published kit that matches a served capability (the scorecard also carries today's grown-dataset status, honestly)
...
<details>
<summary><b>Every feature is verified end-to-end in a real browser</b> — 232 Playwright suites. Expand the full ledger, one honest paragraph per epoch…</summary>

**Every feature is verified end-to-end in a real browser** — 232 Playwright suites drive the
