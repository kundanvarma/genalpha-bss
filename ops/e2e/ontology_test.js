...
(async () => {
  ...
  await browser.close();
  console.log('\nPASS ontology_test — the registry loads and resolves; conformance holds; a customer\'s line was upgraded through the registry with a receipt; MCP, explain, overlay and SDK proven');
